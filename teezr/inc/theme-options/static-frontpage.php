...
WP_Bootstrap_4_Kirki::add_section( 'wp_bp_frontpage', array(
    'title'          => esc_html__( 'Static Frontpage', 'teezr' ),
    'panel'          => 'theme_options',
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( 'Cover Lead', 'teezr' ),
	'section'  => 'wp_bp_frontpage',
	'type'     => 'text',
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( '1st Featured Page', 'teezr' ),
	'section'  => 'wp_bp_frontpage',
	'type'     => 'dropdown-pages',
) );
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( '2nd Featured Page', 'teezr' ),
	'section'  => 'wp_bp_frontpage',
	'type'     => 'dropdown-pages',
) );
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( '3rd Featured Page', 'teezr' ),
	'section'  => 'wp_bp_frontpage',
	'type'     => 'dropdown-pages',
) );
...
WP_Bootstrap_4_Kirki::add_field( 'wp_bootstrap_4_theme', array(
	...
	'label'    => esc_html__( 'Show Main Content', 'teezr' ),
	'section'  => 'wp_bp_frontpage',
	'type'     => 'checkbox',
    'default'  => 1
) );
